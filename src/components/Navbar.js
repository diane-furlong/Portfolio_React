        ...
        <div className="container nav-item">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav ml-auto mt-2 mt-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link" href="/Portfolio_React/AboutMePage/">About Me</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/Portfolio_React/PortfolioPage/">Portfolio</a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="/Portfolio_React/ContactPage/">Contact</a>
              </li>
            </ul>
          </div>
        </div>
